...
public class AryFloatBuilder implements DTObjFieldBuilder {
	private static final DTObjFieldBuilder t = new AryFloatBuilder();
	...
	public void buildFromBytesHolderMContent(MethodVisitor mv, String fieldName, String objName) {
		...
		mv.visitMethodInsn(INVOKEINTERFACE, DATAHOLDER_PATH, "getFloats", "()[F", true);
	...
	public void buildToBytesHolderMContent(MethodVisitor mv, String fieldName, String objName) {
		...
		mv.visitMethodInsn(INVOKEINTERFACE, DATAHOLDER_PATH, "putFloats", "([F)V", true);
	}
