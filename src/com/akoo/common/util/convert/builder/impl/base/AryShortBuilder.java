...
public class AryShortBuilder implements DTObjFieldBuilder {
	private static final DTObjFieldBuilder t = new AryShortBuilder();
	...
	public void buildFromBytesHolderMContent(MethodVisitor mv, String fieldName, String objName) {
		...
		mv.visitMethodInsn(INVOKEINTERFACE, DATAHOLDER_PATH, "getShorts", "()[S", true);
	...
	public void buildToBytesHolderMContent(MethodVisitor mv, String fieldName, String objName) {
		...
		mv.visitMethodInsn(INVOKEINTERFACE, DATAHOLDER_PATH, "putShorts", "([S)V", true);
	}
