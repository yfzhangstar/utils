...
import com.akoo.common.util.cache.AbstractCache.SimpleStatsCounter;
import com.akoo.common.util.cache.AbstractCache.StatsCounter;
import com.akoo.common.util.cache.LocalCache.Strength;
...
public final class CacheBuilder<K, V> {
   ...
   * @since 11.0
   */
  public <K1 extends K, V1 extends V> LocalCache.LocalManualCache<K1, V1> build() {
    checkWeightWithWeigher();
