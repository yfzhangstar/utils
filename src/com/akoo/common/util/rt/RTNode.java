package com.akoo.common.util.rt;
...
public abstract class RTNode {
     ...
     * R树的根节点为T，检测是否有相交的矩形
     * <p>
     * 1、如果T不是叶子结点，则逐个查找T中的每个条目是否相交rectangle，若包围则递归调用isIntersection()<br>
     * 2、如果T是一个叶子结点，则逐个检查T中的每个条目能否 相交rectangle<br>
     *
     * @param rectangle
     * @return 是否相交
     */
    protected abstract boolean isIntersection(Rectangle rectangle);
