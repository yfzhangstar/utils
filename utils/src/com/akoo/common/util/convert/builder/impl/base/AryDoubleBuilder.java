...
public class AryDoubleBuilder implements DTObjFieldBuilder {
	private static final DTObjFieldBuilder t = new AryDoubleBuilder();
	...
	public void buildFromBytesHolderMContent(MethodVisitor mv, String fieldName, String objName) {
		...
		mv.visitMethodInsn(INVOKEINTERFACE, DATAHOLDER_PATH, "getDoubles", "()[D", true);
	...
	public void buildToBytesHolderMContent(MethodVisitor mv, String fieldName, String objName) {
		...
		mv.visitMethodInsn(INVOKEINTERFACE, DATAHOLDER_PATH, "putDoubles", "([D)V", true);
	}
